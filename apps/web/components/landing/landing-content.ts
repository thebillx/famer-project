...
export const heroContent = {
  ...
  title: "เห็นข้อมูลแปลงชัดขึ้น ก่อนออกไปดูพื้นที่จริง",
  description:
    "AgriScope ช่วยบันทึกขอบเขตแปลง คำนวณพื้นที่อ้างอิง และค้นหาเมทาดาทาภาพ Sentinel-2 ล่าสุด เพื่อให้ทีมเลือกข้อมูลประกอบการตรวจแปลงได้ง่ายขึ้น",
